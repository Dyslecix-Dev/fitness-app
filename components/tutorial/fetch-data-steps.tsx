  ...
  return (
    <ol className="flex flex-col gap-6">
      ...
      <TutorialStep title="Enable Row Level Security (RLS)">
        <p>
          Supabase enables Row Level Security (RLS) by default. To query data from your <code>notes</code> table, you need to add a policy. You can do this in the{" "}
          <a href="https://supabase.com/dashboard/project/_/editor" className="font-bold hover:underline text-foreground/80" target="_blank" rel="noreferrer">
            Table Editor
          </a>{" "}
          or via the{" "}
        ...
        <p>
          ...
          <a href="https://supabase.com/docs/guides/auth/row-level-security" className="font-bold hover:underline text-foreground/80" target="_blank" rel="noreferrer">
            Supabase docs
          </a>
          .
        </p>
      ...
      <TutorialStep title="Query Supabase data from Next.js">
        <p>
          ...
          <span className="relative rounded bg-muted px-[0.3rem] py-[0.2rem] font-mono text-xs font-medium text-secondary-foreground border">/app/notes/page.tsx</span> and add the following.
        </p>
