...
export async function updateSession(request: NextRequest) {
  ...
  // NOTE: with Fluid compute, don't put this client in a global environment variable. Always create a new one on each request.
  ...
  // NOTE: If you remove getClaims() and you use server-side rendering with the Supabase client, your users may be randomly logged out.
  ...
  // NOTE: You *must* return the supabaseResponse object as it is.
